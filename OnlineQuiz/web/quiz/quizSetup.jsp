<%-- 
    Document   : QuizSelect
    Created on : 10-Jun-2021, 10:27:43
    Author     : haiva
--%>
    ...
    <body>
        <div id="main-area">
            ...
            <div id="main-content">
                ...
                <div id="numberQuiz"> Enter number of questions: </div>
                <form method="POST" action="quizSetup">
                    <input id="setNumberQuiz" name="setNumberQuiz" value=""> <br>
                    <div id="start-button">
                        <input id="start" type="submit" name="submitForm" value="Start">    
                    </div>
                </form>
            </div>
        </div>
